...
public class AppiumTest implements SauceOnDemandSessionIdProvider {
    ...
    /** Page object references. Allows using 'home' instead of 'HomePage' (Appium object) **/
    ...
    public @Rule
    SauceOnDemandTestWatcher reportToSauce = new SauceOnDemandTestWatcher(this, auth, false); // false to silence Sauce connect messages.
    ...
    public void setUp() throws Exception {
        ...
        capabilities.setCapability("appium-version", "2.2.0");
        ...
        if (runOnSauce) {
            ...
            driver = new AndroidDriver(serverAddress, capabilities); //Appium!
        }
