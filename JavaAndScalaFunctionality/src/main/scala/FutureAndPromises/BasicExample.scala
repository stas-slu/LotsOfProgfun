...
import scala.concurrent._ // import future, maps, for, ExecutionContent
import ExecutionContext.Implicits.global // futures will spawn threads in the global context thread pool
import scala.util.Random


//http://www.srirangan.net/2013-01-first-steps-with-scala-futures
